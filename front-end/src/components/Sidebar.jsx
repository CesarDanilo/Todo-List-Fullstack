          ...
          {['ALL TASKS', 'PENDING', 'COMPLETED'].map((item) => {
            ...
            return (
              <li
                ...
                className={`flex justify-between items-center cursor-pointer text-gray-950 font-sans text-lg hover:bg-[#E4E4E4] p-2 rounded ${
                  activeItem === item ? 'border-l-4 border-black bg-[#E4E4E4]' : ''
                }`}
              >
                <span>{item}</span>
